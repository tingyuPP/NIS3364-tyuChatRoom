...
class Ui_ChatRoom_Window(object):
    def setupUi(self, ChatRoom_Window):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(-1, -1, 1101, 861))
        ...
        self.widget.setGeometry(QtCore.QRect(-10, 0, 311, 861))
...
"}")
        ...
        self.UserListWidget = ListWidget(self.widget)
...
from qfluentwidgets import ListWidget, PlainTextEdit, PrimaryPushButton, TransparentToolButton
import resource_rc
